...
class MissionSettings
{
	...
	static bool Opt_BuildStatics = true;		//1 = Spawn additional static buildings on startup(check EventsWorldData file), 0 = deploy only missions
	...
	static bool Opt_RPmode = true;				//1 = chronological mission selection for role play purposes, 0 = random mission selection
